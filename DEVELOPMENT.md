...
* 2.1\. Assuming a _.gitattibutes_ file in the root of the script repository with the necessary lines to indicate that contents of its own files in common must prevail over those in the _super-repository_:
